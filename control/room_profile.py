...
class RoomProfile:
    ...
    bottom-to-top effect means the fixtures are declared bottom-to-top. Each
    fixture now has its own session and lane space (spec section 3.5), so
    this profile no longer refuses two fixtures' generators sharing a lane;
    that collision check moved to GameServer.load_bit, after resolution. See
